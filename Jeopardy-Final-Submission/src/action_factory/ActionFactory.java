...
private static HashMap<Class<?>, Action> actionMap;
	...
	public ActionFactory(){
		...
		if (actionMap == null){
			...
			actionMap.put(TimerMessage.class, new StopTimerAction());
			actionMap.put(NoBuzzMessage.class, new NoBuzzAction());
			actionMap.put(QuestionExpireMessage.class, new QuestionExpireAction());
		}
	}
